                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Here's a Quick Access to Upcoming Appointments that is until 7 days<br>
                                ...
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;text-align:right;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Here's a Quick Access to Upcoming Sessions that is scheduled until 7 days<br>
                            ...
                            <tr>
                                <td width="50%">
                                    <center>
                                        ...
                                        <thead>
                                        <tr>    
                                                <th class="table-headin" style="font-size: 15px;"><b>
                                                        
                                                    Appointment Number
                                                    
                                                </th>
                                                <th class="table-headin"><b>
                                                    Patient Name
                                                </th>
                                                <th class="table-headin"><b>
